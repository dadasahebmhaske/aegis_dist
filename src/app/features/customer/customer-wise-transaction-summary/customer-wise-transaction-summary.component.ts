...
@Component({
  selector: 'sa-customer-wise-transaction-summary',
  templateUrl: './customer-wise-transaction-summary.component.html',
  styleUrls: ['./customer-wise-transaction-summary.component.css']
})
export class CustomerWiseTransactionSummaryComponent implements OnInit, OnDestroy {
  public cpInfo: any = {};
  public chantype: any = [];
  ...
  onLoad() {
    ...
    this.customerService.getCustomerWiseTransactionSummary(this.deliverFilter.CPCode, this.deliverFilter, this.appService.DateToString(this.deliverFilter.StartDate), this.appService.DateToString(this.deliverFilter.EndDate)).subscribe((resData: any) => {
      this.loaderbtn = true;
