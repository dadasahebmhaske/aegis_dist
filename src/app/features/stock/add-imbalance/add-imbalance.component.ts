...
export class AddImbalanceComponent implements OnInit {
  ...
  configureGrid() {
    ...
    columnDefs = [
      ...
      { name: 'ReferenceNo', displayName: 'Imbalance Ref No.', cellClass: 'cell-center', width: "145", cellTooltip: true, filterCellFiltered: true, visible: false },
      { name: 'ImbalanceDate', displayName: 'Imbalance Date ', cellClass: 'cell-center', width: "160", cellTooltip: true, filterCellFiltered: true },
      { name: 'SoundPlus', displayName: 'Sound (+) Qty', width: "128", cellClass: 'cell-right', cellTooltip: true, filterCellFiltered: true },
      { name: 'SoundMinus', displayName: 'Sound (-) Qty', width: "120", cellClass: 'cell-right', cellTooltip: true, filterCellFiltered: true },
      { name: 'EmptyPlus', displayName: 'Empty (+) Qty ', width: "125", cellClass: 'cell-right', cellTooltip: true, filterCellFiltered: true },
      { name: 'EmptyMinus', displayName: 'Empty (-) Qty ', width: "120", cellClass: 'cell-right', cellTooltip: true, filterCellFiltered: true },
      { name: 'DefPlus', displayName: 'Defective (+) Qty', width: "145", cellClass: 'cell-right', cellTooltip: true, filterCellFiltered: true },
      { name: 'DefMinus', displayName: 'Defective (-) Qty', width: "145", cellClass: 'cell-right', cellTooltip: true, filterCellFiltered: true },
