...
export class GodownMasterComponent implements OnInit {
  ...
  configureGrid() {
    ...
    columnDefs = [
      ...
      { name: 'ContactNo', displayName: 'Contact No.', width: "110", cellTooltip: true, filterCellFiltered: true },
      { name: 'LicNo', displayName: 'License No.', width: "160", cellTooltip: true, filterCellFiltered: true },
      { name: 'LicIssueDate', displayName: 'LicIssue Date', width: "130", cellTooltip: true, filterCellFiltered: true },
      { name: 'LicExpDate', displayName: 'LicExp Date', width: "130", cellTooltip: true, filterCellFiltered: true },
      { name: 'LastAuditDate', displayName: 'Last Audit Date', width: "130", cellTooltip: true, filterCellFiltered: true },
      { name: 'GodownTypeName', displayName: 'Godown Type', width: "130", cellTooltip: true, filterCellFiltered: true },
      { name: 'LeasePeriod', displayName: 'Lease Period', width: "110", cellTooltip: true, filterCellFiltered: true },
