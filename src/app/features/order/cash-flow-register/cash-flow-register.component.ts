...
export class CashFlowRegisterComponent implements OnInit {
  ...
  configureGrid() {
    ...
    columnDefs = [
      ...
      // },
      { name: 'ConsNo', displayName: 'Customer No.', width: "125", cellTooltip: true, filterCellFiltered: true, visible: true },
      ...
      { name: 'PayDate', displayName: 'Payment Date', width: "150", cellTooltip: true, filterCellFiltered: true },
      { name: 'SalesAmount', displayName: 'Sales Amount', width: "130", cellTooltip: true, filterCellFiltered: true },
      { name: 'PaidAmount', displayName: 'Received Amount', width: "150", cellTooltip: true, filterCellFiltered: true },
      { name: 'PendingAmt', displayName: 'Pending Amount', width: "150", cellTooltip: true, filterCellFiltered: true },
      { name: 'AdvanceAmt', displayName: 'Advanced Amount', width: "155", cellTooltip: true, filterCellFiltered: true },
      { name: 'PayMode', displayName: 'Payment Mode', width: "140", cellTooltip: true, filterCellFiltered: true },
      { name: 'ChequeNo', displayName: 'Cheque No.', width: "130", cellTooltip: true, filterCellFiltered: true },
      { name: 'ChequeDate', displayName: 'Cheque Date', width: "130", cellTooltip: true, filterCellFiltered: true },
